...
def draw_pattern():
    ...
    def first_line():
     draw_element(color[1],12) ; draw_element(color[0],3) ; draw_element(color[1],9) ; print('',end = '')
    def second_line():
        draw_element(color[1],9) ; draw_element(color[0],3) ; draw_element(color[1],3) ; draw_element(color[0],3) ; draw_element(color[1],6) ; print('',end = '')
    def third_line():
        draw_element(color[1],6) ; draw_element(color[0],3) ; draw_element(color[1],9) ; draw_element(color[0],3) ; draw_element(color[1],3) ; print('',end = '')
    def fourth_line():
        draw_element(color[1],3) ; draw_element(color[0],3) ; draw_element(color[1],15) ; draw_element(color[0],3) ; draw_element(color[1],0) ; print('',end = '')
    def fifth_line():
        draw_element(color[0],3) ; draw_element(color[1],21) ; draw_element(color[0],0) ; print('',end = '')

    for i in range(4):
        first_line() ; first_line() ; first_line() ; first_line() ; draw_element(color[1],3) ; print()
        second_line() ; second_line() ; second_line() ; second_line() ; draw_element(color[1],3) ; print()
        third_line() ; third_line() ; third_line() ; third_line() ; draw_element(color[1],3) ; print()
        fourth_line() ; fourth_line() ; fourth_line() ; fourth_line() ; draw_element(color[1],3) ; print()
        fifth_line() ; fifth_line() ; fifth_line() ; fifth_line() ; draw_element(color[0],3) ; print()
        fourth_line() ; fourth_line() ; fourth_line() ; fourth_line() ; draw_element(color[1],3) ; print()
        third_line() ; third_line() ; third_line() ; third_line() ; draw_element(color[1],3) ; print()
        second_line() ; second_line() ; second_line() ; second_line() ; draw_element(color[1],3) ; print()
    first_line() ; first_line() ; first_line() ; first_line() ; draw_element(color[1],3) ; print()
